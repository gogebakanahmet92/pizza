...
export class Home extends Component {
  ...
  seeResult(e) {
    let indexValue = e.target.parentNode.parentNode
  ...
  render() {
    ...
    var current_image_name =
      this.state.current_task_name + this.state.current_image + ".png";
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        ...
                        className="SeeResultsField"
                      >
                        Results
                      </button>
                      <button className="DeleteField">Delete</button>
                    </td>
                  </tr>
                ))}
              </table>
        ...
        {this.state.image_container === true ? (
          <div className="ImageContainerField">
            ...
            <div className="PizzaSelectionField">
              {task_path[this.state.indexValue]
                .split(",")
                .map((column, index) => (
                  <button onClick={this.showImage} className="Results">
                    {column.trim()}
                  </button>
                ))}
            </div>
